...
def _run_light_migrations(sync_conn: Connection) -> None:
    ...
    add("lpus", "approval_status", "approval_status VARCHAR(20) DEFAULT 'pending'")
    ...
    add("pharmacies", "user_id", "user_id INTEGER")
    add("pharmacies", "ball_balance", "ball_balance INTEGER DEFAULT 0")
    add("ball_transactions", "to_pharmacy_id", "to_pharmacy_id INTEGER")
