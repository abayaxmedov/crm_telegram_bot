...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "your_region": {UZ_CYRL: "Регион", RU: "Регион"},
    "greeting_hello": {UZ_CYRL: "Ассалому алайкум", RU: "Здравствуйте"},
    ...
    "btn_user_deactivate": {UZ_CYRL: "🚫 Фаолсизлантириш", RU: "🚫 Деактивировать"},
    "btn_user_activate": {UZ_CYRL: "✅ Фаоллаштириш", RU: "✅ Активировать"},
    "btn_user_delete": {UZ_CYRL: "🗑 Бутунлай ўчириш", RU: "🗑 Удалить полностью"},
    "btn_user_delete_yes": {UZ_CYRL: "⚠️ Ҳа, бутунлай ўчириш", RU: "⚠️ Да, удалить полностью"},
    "user_deactivated": {
        UZ_CYRL: "🚫 Фойдаланувчи фаолсизлантирилди: {name}. Энди у ботга кира олмайди.",
        RU: "🚫 Пользователь деактивирован: {name}. Теперь у него нет доступа к боту.",
    },
    "user_activated": {UZ_CYRL: "✅ Фойдаланувчи фаоллаштирилди: {name}.", RU: "✅ Пользователь активирован: {name}."},
    "user_delete_confirm": {
        UZ_CYRL: (
            "⚠️ <b>{name}</b>ни БУТУНЛАЙ ўчирасизми?\n\n"
            "Унинг сотувлари, кундалик ҳисоботлари, ойликлари ва склад заявкалари ҳам "
            "ўчиб кетади. Бу амални ҚАЙТАРИБ БЎЛМАЙДИ."
        ),
        RU: (
            "⚠️ Удалить <b>{name}</b> ПОЛНОСТЬЮ?\n\n"
            "Его продажи, ежедневные отчёты, зарплаты и складские заявки также будут "
            "удалены. Это действие НЕОБРАТИМО."
        ),
    },
    "user_deleted": {UZ_CYRL: "🗑 Фойдаланувчи бутунлай ўчирилди: {name}.", RU: "🗑 Пользователь полностью удалён: {name}."},
    "user_delete_cancelled": {UZ_CYRL: "Ўчириш бекор қилинди.", RU: "Удаление отменено."},
    "user_cannot_self": {
        UZ_CYRL: "⚠️ Ўз ҳисобингизни ўчира/фаолсизлантира олмайсиз.",
        RU: "⚠️ Нельзя удалить/деактивировать свой аккаунт.",
    },
    # ---- Xodim ma'lumotlarини tahrirlash (owner) ----
    "btn_user_edit": {UZ_CYRL: "✏️ Таҳрирлаш", RU: "✏️ Редактировать"},
    "btn_ue_name": {UZ_CYRL: "👤 Исм (ФИО)", RU: "👤 Имя (ФИО)"},
    "btn_ue_phone": {UZ_CYRL: "☎️ Телефон", RU: "☎️ Телефон"},
    "btn_ue_role": {UZ_CYRL: "🎖 Рол", RU: "🎖 Роль"},
    "btn_ue_region": {UZ_CYRL: "🌐 Регион", RU: "🌐 Регион"},
    "ue_menu": {
        UZ_CYRL: "✏️ <b>{name}</b> — нимани таҳрирлаймиз?",
        RU: "✏️ <b>{name}</b> — что редактируем?",
    },
    "ue_enter_name": {UZ_CYRL: "Янги ФИО киритинг:", RU: "Введите новое ФИО:"},
    "ue_enter_phone": {
        UZ_CYRL: "Янги телефон рақамини киритинг (ёки <code>-</code>):",
        RU: "Введите новый номер телефона (или <code>-</code>):",
    },
    "ue_choose_role": {UZ_CYRL: "Янги ролни танланг:", RU: "Выберите новую роль:"},
    "ue_choose_region": {UZ_CYRL: "Янги регионни танланг:", RU: "Выберите новый регион:"},
    "ue_no_regions": {UZ_CYRL: "Регионлар йўқ.", RU: "Регионов нет."},
    "user_edited_ok": {UZ_CYRL: "✅ Таҳрирланди: {name}", RU: "✅ Отредактировано: {name}"},
    # ---- Doktor ma'lumotlarини tahrirlash (owner/TOP/product) ----
    "btn_doctor_edit": {UZ_CYRL: "✏️ Таҳрирлаш", RU: "✏️ Редактировать"},
    "btn_de_name": {UZ_CYRL: "👤 ФИО", RU: "👤 ФИО"},
    "btn_de_phone": {UZ_CYRL: "☎️ Телефон", RU: "☎️ Телефон"},
    "btn_de_category": {UZ_CYRL: "🏷 Категория", RU: "🏷 Категория"},
    "btn_de_region": {UZ_CYRL: "🌐 Регион", RU: "🌐 Регион"},
    "btn_de_lpu": {UZ_CYRL: "🏥 ЛПУ", RU: "🏥 ЛПУ"},
    "de_menu": {
        UZ_CYRL: "✏️ <b>{name}</b> — нимани таҳрирлаймиз?",
        RU: "✏️ <b>{name}</b> — что редактируем?",
    },
    "de_choose_region": {UZ_CYRL: "Янги регионни танланг:", RU: "Выберите новый регион:"},
    "doctor_edited_ok": {UZ_CYRL: "✅ Доктор таҳрирланди: {name}", RU: "✅ Врач отредактирован: {name}"},
    ...
    "enter_location_geo": {
        ...
        RU: "📍 Введите локацию — напишите текстом или отправьте своё местоположение кнопкой ниже:",
    },
    ...
    "sales_no_pharmacy_stock": {
        UZ_CYRL: "Бу дорихонада қолдиқ (остаток) йўқ. Аввал складдан дори олинг (склад заявка).",
        RU: "В этой аптеке нет остатка. Сначала возьмите товар со склада (складская заявка).",
    },
    ...
    # ---- Заявка на склад ----
    "wh_choose_method": {
        UZ_CYRL: "📦 Складга заявка — аптекани қандай топамиз?",
        RU: "📦 Заявка на склад — как найдём аптеку?",
    },
    "btn_wh_by_inn": {UZ_CYRL: "🔢 ИНН орқали топиш", RU: "🔢 Найти по ИНН"},
    "btn_wh_by_list": {UZ_CYRL: "📋 Аптекалар рўйхати", RU: "📋 Список аптек"},
    "wh_enter_inn": {UZ_CYRL: "ИНН ни киритинг:", RU: "Введите ИНН:"},
    "wh_list_header": {
        UZ_CYRL: "📋 Аптекалар рўйхати. Керакли аптека ID рақамини қуйидаги тугмалардан танланг:",
        RU: "📋 Список аптек. Выберите ID нужной аптеки кнопкой ниже:",
    },
    "wh_list_empty": {
        UZ_CYRL: "Сизнинг регионингизда (тасдиқланган) аптека йўқ.",
        RU: "В вашем регионе нет (подтверждённых) аптек.",
    },
    "wh_search_pharmacy": {
    ...
    "wh_choose_payment": {
        UZ_CYRL: (
            "💰 <b>Дорихона тўлов шарти</b>\n\n"
            "Дорилар учун қанча олдиндан тўлайди?\n"
            "• <b>100%</b> — тўлиқ олдиндан (нарх арзонроқ)\n"
            "• <b>50%</b> — ярми олдиндан, қолгани кейин (нарх қимматроқ)"
        ),
        RU: (
            "💰 <b>Условие оплаты аптеки</b>\n\n"
            "Сколько платит вперёд за препараты?\n"
            "• <b>100%</b> — полная предоплата (цена дешевле)\n"
            "• <b>50%</b> — половина вперёд, остаток позже (цена дороже)"
        ),
    },
    "btn_pay_100": {UZ_CYRL: "💵 100% олдиндан", RU: "💵 100% предоплата"},
    "btn_pay_50": {UZ_CYRL: "💳 50% олдиндан", RU: "💳 50% предоплата"},
    "wh_payment_set": {
        UZ_CYRL: "✅ Тўлов шарти: <b>{percent}%</b>. Энди препаратларни танланг.",
        RU: "✅ Условие оплаты: <b>{percent}%</b>. Теперь выберите препараты.",
    },
    ...
    "btn_wholesalers": {UZ_CYRL: "🏭 Оптомлар", RU: "🏭 Оптовики"},
    "btn_wholesaler_add": {UZ_CYRL: "➕ Оптом қўшиш", RU: "➕ Добавить оптовика"},
    "btn_wholesaler_list": {UZ_CYRL: "📋 Оптомлар рўйхати", RU: "📋 Список оптовиков"},
    "wholesalers_text": {
        UZ_CYRL: "🏭 Оптомлар бўлими\nМенюдан амални танланг:",
        RU: "🏭 Раздел оптовиков\nВыберите действие из меню:",
    },
    "wholesalers_header": {UZ_CYRL: "🏭 Оптомлар рўйхати:", RU: "🏭 Список оптовиков:"},
    "wholesalers_empty": {
        UZ_CYRL: "Ҳозирча оптом қўшилмаган. ➕ Оптом қўшиш орқали яратинг.",
        RU: "Оптовики пока не добавлены. Создайте через ➕ Добавить оптовика.",
    },
    "enter_wholesaler_name": {UZ_CYRL: "Оптом номини киритинг:", RU: "Введите название оптовика:"},
    "enter_wholesaler_inn": {UZ_CYRL: "Оптом ИНН сини киритинг (ёки <code>-</code>):", RU: "Введите ИНН оптовика (или <code>-</code>):"},
    "enter_wholesaler_phone": {UZ_CYRL: "Оптом телефон рақамини киритинг (ёки <code>-</code>):", RU: "Введите телефон оптовика (или <code>-</code>):"},
    "wholesaler_saved": {
        UZ_CYRL: "✅ Оптом сақланди.\n#{id} | {name} | ИНН {inn} | {phone}",
        RU: "✅ Оптовик сохранён.\n#{id} | {name} | ИНН {inn} | {phone}",
    },
    "wholesaler_card": {
        UZ_CYRL: "🏭 Оптом #{id}\n📛 Номи: {name}\n🔢 ИНН: {inn}\n📞 Телефон: {phone}",
    ...
    "no_perm_wholesalers": {
        UZ_CYRL: "Оптомларни фақат owner яратади.",
        RU: "Оптовиков может создавать только owner.",
    },

    "btn_wholesale_income": {UZ_CYRL: "📥 Оптомдан приход", RU: "📥 Приход от оптовика"},
    "wi_choose_pharmacy": {
        UZ_CYRL: "📥 Оптомдан приход\nҚайси аптека оптомдан приход олди — танланг:",
        RU: "📥 Приход от оптовика\nВыберите аптеку, которая получила приход:",
    },
    "wi_choose_wholesaler": {UZ_CYRL: "Қайси оптомдан олинди — танланг:", RU: "Выберите оптовика, от которого получено:"},
    "wi_no_wholesalers": {
        UZ_CYRL: "Оптомлар рўйхати бўш. Owner оптом яратиши керак.",
        RU: "Список оптовиков пуст. Owner должен создать оптовика.",
    },
    "wi_choose_drug": {UZ_CYRL: "Приходга қўшиш учун препаратни танланг:", RU: "Выберите препарат для прихода:"},
    "wi_enter_qty": {UZ_CYRL: "{name} — оптомдан олинган сонни киритинг:", RU: "{name} — введите полученное количество:"},
    "wi_cart_title": {UZ_CYRL: "📥 Жорий приход:", RU: "📥 Текущий приход:"},
    "wi_done": {
        UZ_CYRL: (
            "✅ Приход №{id} тасдиққа юборилди (TOP менежер).\n"
            "Аптека: {pharmacy}\nОптом: {wholesaler}\n\n{detail}\n\n"
            "Тасдиқлангач аптека қолдиғи ошади."
        ),
        RU: (
            "✅ Приход №{id} отправлен на подтверждение (TOP менеджер).\n"
            "Аптека: {pharmacy}\nОптовик: {wholesaler}\n\n{detail}\n\n"
            "После подтверждения остаток аптеки увеличится."
        ),
    },
    "btn_wi_approve": {UZ_CYRL: "📥 Оптом приходи тасдиғи", RU: "📥 Подтверждение прихода"},
    "wi_approve_header": {UZ_CYRL: "📥 Тасдиқ кутаётган приходлар:", RU: "📥 Приходы, ожидающие подтверждения:"},
    "wi_approve_empty": {
        UZ_CYRL: "Тасдиқ кутаётган приходлар йўқ.",
        RU: "Нет приходов, ожидающих подтверждения.",
    },
    "wi_card": {
        UZ_CYRL: "📥 Приход №{id}\n👤 Медвакил: {rep}\n💊 Аптека: {pharmacy}\n🏭 Оптом: {wholesaler}\n📅 {date}\n\n{items}",
    ...
    "new_wi_for_approve": {
        UZ_CYRL: "🆕 <b>Оптомдан янги приход — тасдиқлаш керак</b>\n\n{card}",
        RU: "🆕 <b>Новый приход от оптовика — требуется подтверждение</b>\n\n{card}",
    },
    "wi_approved": {
        UZ_CYRL: "✅ Приход №{id} тасдиқланди. Аптека қолдиғи ошди.",
        RU: "✅ Приход №{id} подтверждён. Остаток аптеки увеличен.",
    },
    "wi_rejected": {UZ_CYRL: "❌ Приход №{id} рад этилди.", RU: "❌ Приход №{id} отклонён."},
    "wi_not_found": {
        UZ_CYRL: "Приход топилмади ёки аллақачон кўриб чиқилган.",
        RU: "Приход не найден или уже рассмотрен.",
    },
    "wi_approved_rep": {
        UZ_CYRL: "✅ Приход №{id} ({pharmacy}) TOP менежер томонидан тасдиқланди — аптека қолдиғи янгиланди.",
        RU: "✅ Приход №{id} ({pharmacy}) подтверждён TOP менеджером — остаток аптеки обновлён.",
    },
    "wi_rejected_rep": {
    ...
    "wh_request_card": {
        UZ_CYRL: (
            "📦 Заявка №{id}\n👤 Медвакил: {rep}\n💊 Аптека: {pharmacy}\n📄 {contract}\n"
            "💰 Тўлов: {percent}% олдиндан\n📅 {date}\n\n{items}\n\n💰 Жами: {total}"
        ),
        RU: (
            "📦 Заявка №{id}\n👤 Медпредставитель: {rep}\n💊 Аптека: {pharmacy}\n📄 {contract}\n"
            "💰 Оплата: {percent}% предоплата\n📅 {date}\n\n{items}\n\n💰 Итого: {total}"
        ),
    },
    "btn_wh_ok": {UZ_CYRL: "🚚 Отгрузка ёзиш", RU: "🚚 Записать отгрузку"},
    "wh_ship_intro": {
        UZ_CYRL: (
            "🚚 <b>Заявка №{id} — отгрузка</b>\n"
            "Аптека: {pharmacy}\n\n"
            "Ҳар бир препарат учун складдан аптекага ҲАҚИҚАТДА юборилган сонни киритинг.\n"
            "Аптека қолдиғи фақат шу сонларга қараб ўзгаради."
        ),
        RU: (
            "🚚 <b>Заявка №{id} — отгрузка</b>\n"
            "Аптека: {pharmacy}\n\n"
            "Для каждого препарата введите количество, ФАКТИЧЕСКИ отгруженное со склада в аптеку.\n"
            "Остаток аптеки изменится только по этим числам."
        ),
    },
    "wh_ship_ask": {
        UZ_CYRL: "{index}/{count} — <b>{name}</b>\nСўралган: {requested} {pcs}.\nЮборилган сонни киритинг (0 — юборилмади):",
        RU: "{index}/{count} — <b>{name}</b>\nЗапрошено: {requested} {pcs}.\nВведите отгруженное количество (0 — не отгружено):",
    },
    "wh_ship_invalid": {
        UZ_CYRL: "Нотўғри сон. 0 ёки ундан катта бутун сон киритинг:",
        RU: "Неверное число. Введите целое число 0 или больше:",
    },
    "wh_ship_row": {
        UZ_CYRL: "сўралган {requested}, юборилди <b>{shipped}</b>",
        RU: "запрошено {requested}, отгружено <b>{shipped}</b>",
    },
    "wh_ship_summary": {
        UZ_CYRL: "🚚 Отгрузка:\n{detail}\n\n💰 Отгрузка суммаси: {total}",
        RU: "🚚 Отгрузка:\n{detail}\n\n💰 Сумма отгрузки: {total}",
    },
    "wh_ship_nothing": {
        UZ_CYRL: "⚠️ Ҳамма препаратлар учун 0 киритилди — отгрузка йўқ. Заявкани рад этинг ёки қайтадан киритинг.",
        RU: "⚠️ По всем препаратам введено 0 — отгрузки нет. Отклоните заявку или введите заново.",
    },
    "btn_wh_reject": {UZ_CYRL: "❌ Рад этиш", RU: "❌ Отклонить"},
    "wh_approved": {
        UZ_CYRL: "✅ Заявка №{id} отгрузка қилинди. Аптека қолдиғи юборилган сонларга қараб янгиланди.",
        RU: "✅ Заявка №{id} отгружена. Остаток аптеки обновлён по отгруженным количествам.",
    },
    ...
    "btn_doctor_approve": {UZ_CYRL: "🧑‍⚕️ Доктор тасдиғи", RU: "🧑‍⚕️ Подтверждение врача"},
    "btn_pharmacy_approve": {UZ_CYRL: "💊 Дорихона тасдиғи", RU: "💊 Подтверждение аптеки"},
    "doctor_approve_empty": {
        UZ_CYRL: "Тасдиқлашни кутаётган доктор йўқ.",
        RU: "Нет врачей, ожидающих подтверждения.",
    },
    "pharmacy_approve_empty": {
        UZ_CYRL: "Тасдиқлашни кутаётган дорихона йўқ.",
        RU: "Нет аптек, ожидающих подтверждения.",
    },
    "doctor_approve_header": {
        UZ_CYRL: "🧑‍⚕️ Тасдиқлашни кутаётган докторлар:",
        RU: "🧑‍⚕️ Врачи, ожидающие подтверждения:",
    },
    "pharmacy_approve_header": {
        UZ_CYRL: "💊 Тасдиқлашни кутаётган дорихоналар:",
        RU: "💊 Аптеки, ожидающие подтверждения:",
    },
    "doctor_card_pending": {
        UZ_CYRL: "🧑‍⚕️ Доктор №{id}\nФИО: {name}\n☎️ {phone}\n📍 {location}\n🗺 Регион: {region}\n👤 Яратди: {author}",
        RU: "🧑‍⚕️ Врач №{id}\nФИО: {name}\n☎️ {phone}\n📍 {location}\n🗺 Регион: {region}\n👤 Создал: {author}",
    ...
    "btn_doctor_balance": {UZ_CYRL: "💰 Балансим", RU: "💰 Мой баланс"},
    "doctor_balance_text": {
        UZ_CYRL: "💰 <b>Балансингиз:</b> {balance} балл",
        RU: "💰 <b>Ваш баланс:</b> {balance} баллов",
    },
    "ball_balance_text": {
    ...
    "enter_drug_price_100": {
        UZ_CYRL: "💵 <b>100% олдиндан тўлов</b> учун нархни киритинг (сўм) — тўлиқ тўлаганда, арзонроқ:",
        RU: "💵 Цена при <b>100% предоплате</b> (сум) — при полной оплате, дешевле:",
    },
    "enter_drug_price_50": {
        UZ_CYRL: "💳 <b>50% олдиндан тўлов</b> учун нархни киритинг (сўм) — қолгани кейин (бўлиб тўлаш, қимматроқ):",
        RU: "💳 Цена при <b>50% предоплате</b> (сум) — остаток позже (рассрочка, дороже):",
    },
    ...
    "drug_saved": {
        UZ_CYRL: "✅ Препарат сақланди: #{id} {name}\n💵 100%: {price100} | 💳 50%: {price50} | 💠 Балл: {ball}",
        RU: "✅ Препарат сохранён: #{id} {name}\n💵 100%: {price100} | 💳 50%: {price50} | 💠 Балл: {ball}",
    },
    "drug_updated": {
        UZ_CYRL: "✅ Янгиланди: {name}\n💵 100%: {price100} | 💳 50%: {price50} | 💠 Балл: {ball}",
        RU: "✅ Обновлено: {name}\n💵 100%: {price100} | 💳 50%: {price50} | 💠 Балл: {ball}",
    },
    ...
    "drug_row": {
        UZ_CYRL: "#{id} | {name} | 💵100%: {price100} | 💳50%: {price50} | 💠{ball}",
        RU: "#{id} | {name} | 💵100%: {price100} | 💳50%: {price50} | 💠{ball}",
    },
    ...
    "pharmacy_stock_header": {
        ...
        RU: "💊 <b>{name}</b> — остаток товара:",
    },
    "pharmacy_stock_empty": {
        UZ_CYRL: "Бу дорихонада ҳозирча дори қолдиғи йўқ.",
        RU: "В этой аптеке пока нет остатка товара.",
    },
    "pharmacy_stock_row": {UZ_CYRL: "• {name}: {qty} шт.", RU: "• {name}: {qty} шт."},
    ...
    "enter_contract_date": {
        UZ_CYRL: "📅 Шартнома санасини киритинг (масалан: 20.05.2026):",
        RU: "📅 Введите дату договора (например: 20.05.2026):",
    },
    "new_pharmacy_for_approve": {
        UZ_CYRL: "🆕 <b>Янги дорихона тасдиқлашни кутмоқда</b>\n\n{card}",
        RU: "🆕 <b>Новая аптека ожидает подтверждения</b>\n\n{card}",
    },
    ...
    "report_pick_lpu": {
        UZ_CYRL: "🏥 Аввал ЛПУ (ДПМ) ни танланг — сўнг ундаги докторлар чиқади:",
    ...
    "no_region_assigned": {
        UZ_CYRL: (
            "⚠️ Сизга регион бириктирилмаган. Админга мурожаат қилинг — "
            "регион бириктирилгач ЛПУ ва доктор яратиш очилади."
        ),
        RU: (
            "⚠️ Вам не назначен регион. Обратитесь к админу — после назначения региона "
            "создание ЛПУ и врачей станет доступным."
        ),
    },
    "doctor_choose_lpu": {
